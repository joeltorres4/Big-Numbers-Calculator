...
/**
 * Represents a candidate command to be executed. The command relates to a
 * particular SystemCommand and to a CommandProcessor that dictates how the
 * command is to be executed in the particular system.
 * 
...
public class FixedLengthCommand extends Command {
	 ...
	 * 
	 * @param line
	 *            the attempted command with its operands.
	 */
	...
	/**
	 * Get operand from specified index
	 * 
	 * @param index
	 *            index of operand
