...
/**
 * Class to represent commands of the system. All commands follow a similar
 * format: oper_name op1 op2 ...
 * 
 * There shall be one instance of this odt for each command that the system is
 * able to process. For each command, it contains the operation name (or command
 * name) and the type for each operand, if any.
 * 
...
public class SystemCommand extends Command {
	 ...
	 * 
	 * @param name
	 *            the name of the command or operation code
	 * @param operands
	 *            the list of operants types as a string object
	 * @param cpp
	 *            the associates command processor (how it is executed)
	 */
	private SystemCommand(String commandGrammar, CommandActionHandler cpp, VariableLengthCommandValidator cv) {
	 ...
	 *            grammar to comply with
	 * @param cpp
	 *            the associates command processor (how it is executed)
	 * @return new System Command object with specified grammar and handler
	 */
	public static SystemCommand getFLSC(String commandGrammar, CommandActionHandler cpp) {
	 ...
	 * @return new System Command object with specified grammar and handler
	 */
	public static SystemCommand getVLSC(String commandGrammar, CommandActionHandler cpp) {
	 ...
	 * 
	 * @param index
	 *            operand index to be retrieved.
	 * @return string value corresponding to the valid type of the specified
	 *         operand.
	 */
	 ...
	 * 
	 * @param c
	 *            CommandLine object to validate
	 * @param errMsg
	 *            Error message associated with command given
