 ...
 *
 *         Class implementing the data type for objects to manage commands as
 *         they are given by the user of the system.
 * 
 */

public abstract class CommandProcessor {

	public final static FixedLengthCommandValidator STDCOMMANDVALIDATOR = new FixedLengthCommandValidator();
	...
	/**
	 * This method does some preliminary processing of the attempted command
	 * being read from user.Determines if a CommandLine object correctly matches
	 * the syntax of some particular system command.
	 * 
	 * @param c
	 *            CommandLine object that is to be analyzed
	 * @param errMsg
	 *            References an empty object where an error message can be
	 *            inserted if an error is detected.
	 ...
	 * @param cl
	 *            input from user
	 * @return Command associated with parameter name
	 */
	...
	/**
	 * Creates command list with given number of states
	 * 
	 * @param nStates
	 *            number of states
	 */
	...
	/**
	 * Adds command to state index in list of commands
	 * 
	 * @param state
	 *            index to add command
	 * @param sc
	 *            system command to add
	 */
	...
	/**
	 * System Command getter
	 * 
	 * @param cName
	 *            name of command
	 * @return SystemCommand object corresponding to cname
	 */
	 ...
	 * @return List of output that are produced by the execution of the command.
	 *         These might be error messages or output produced by its
	...
	/**
	 * This class is used to support the execution of command help wherever
	 * valid to submit such command. Note that the output is shown directly,
	 * without going through an output list or results list as it is done with
	 * other commmands...
	 * 
	 * @author Pedro I. Rivera-Vega
	 *
